...
<?php require('header.php');?>
	...
	<div id="top" class="scrollspy" style = "max-width:1000px;margin:auto;overflow: hidden;">
		...
		<h3 style="color:white;" >Boussole de sociabilité</h3>

		<hr style="color:white;" >

		<h3 style="color:white;" >Trépan Cosmique</h3>
	...
	<section class="indigo darken-3" style="margin-top:50px;">
		<p class=" flow-text">"3ème Espèce, connais-toi toi-même"</p>
		<p class=" flow-text">"L'Humanité est encore jeune" (Engels)"</p>
		<p class=" flow-text">"Que puis-je savoir? Que dois-je faire? Que m'est-il permis d'espérer?" E.Kant</p>
	</section>
	...
	<section class="indigo darken-3 trepan" style="margin-top:50px;">
	...
	<h3 style="color:white;" >Trépan Cosmique</h3>
		...
		<!--<div style = "max-width:1000px;margin:auto;overflow: hidden;color:white;">
			<div class="row">
				<div class="col s2"><div></div><div></div></div>
				<div class="col s2">
					<div style="margin-bottom: 10px;border-bottom: 1px solid white;padding-bottom: 10px;">Humaine</div>
					<div style="width:100%;height:60px;border:1px solid white;">Conception<br>Réalité-Monde</div>
					<div style="width:100%;height:60px;border:1px solid white;">Méthode<br>Fin-Moyens</div>
					<div style="width:100%;height:60px;border:1px solid white;">Exercice<br>Faits-Evènements</div>
					<div style="width:100%;height:60px;border:1px solid white;">Bilan<br>Parole-Geste</div>
					<div style="margin-bottom: 10px;border-bottom: 1px solid white;padding-bottom: 10px;">Humaine</div>
				</div>
				<div class="col s1">
					<div style="margin-bottom: 10px;border-bottom: 1px solid white;padding-bottom: 10px;">-></div>
					<div style="width:100%;height:60px;"><div style="padding-top:20px;"><div style="width:100%;height:10px;background:white;"></div></div></div>
					<div style="width:100%;height:60px;"><div style="padding-top:20px;"><div style="width:100%;height:10px;background:white;"></div></div></div>
					<div style="width:100%;height:60px;"><div style="padding-top:20px;"><div style="width:100%;height:10px;background:white;"></div></div></div>
					<div style="width:100%;height:60px;"><div style="padding-top:20px;"><div style="width:100%;height:10px;background:white;"></div></div></div>
					<div style="margin-bottom: 10px;border-bottom: 1px solid white;padding-bottom: 10px;">-></div>
				...
				<div class="col s2">
					<div style="margin-bottom: 10px;border-bottom: 1px solid white;padding-bottom: 10px;">Nature</div>
					<div style="width:100%;height:60px;border:1px solid white;">Mentalité</div>
					<div style="width:100%;height:60px;border:1px solid white;">Moeurs</div>
					<div style="width:100%;height:60px;border:1px solid white;">Savoir</div>
					<div style="width:100%;height:60px;border:1px solid white;">Faire</div>
					<div style="margin-bottom: 10px;border-bottom: 1px solid white;padding-bottom: 10px;">Nature</div>
				</div>
				<div class="col s1">
					<div style="margin-bottom: 10px;border-bottom: 1px solid white;padding-bottom: 10px;">-></div>
				...
				<div class="col s2">
					<div style="margin-bottom: 10px;border-bottom: 1px solid white;padding-bottom: 10px;">Humaine</div>
					<div style="width:100%;height:60px;border:1px solid white;">Vie Pensée</div>
					<div style="width:100%;height:60px;border:1px solid white;">Pensée vivante</div>
					<div style="width:100%;height:60px;border:1px solid white;">Pensée Vécue</div>
					<div style="width:100%;height:60px;border:1px solid white;">Vie Pensante</div>
					<div style="margin-bottom: 10px;border-bottom: 1px solid white;padding-bottom: 10px;">Humaine</div>
				</div>
