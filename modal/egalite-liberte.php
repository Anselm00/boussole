<!-- Modal Structure -->
<div id="egalite-liberte" class="modal">
			<div class="modal-content">
			  <h4>Egalité-Liberté</h4>
			  
			  <p>« Traiter de notre Histoire humaine au Monde demande ainsi essentiellement que
soient caractérisées les mutations décisives qu’a connu le MODE DE TRAVAIL
...
finir par nous apparaître pour ce qu’ils étaient, des contraires identiques, également
Préhistoriques.</p>
