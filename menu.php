...
<li><a class="modal-trigger vmv" href="#attentif">Attentif</a></li>
<li><a class="modal-trigger vmv" href="#auteur">Auteur</a></li>
<li><a class="modal-trigger vmv" href="#autodidacte">Autodidacte</a></li>
<div>B</div>
<li><a class="modal-trigger electre" href="#bel-ouvrage">Bel Ouvrage</a></li>
<li><a class="modal-trigger vmv" href="#besoins">Besoins</a></li>
...
<li><a class="modal-trigger vmv" href="#cerveau-collectif">Cerveau Collectif</a></li>
<li><a class="modal-trigger vmv" href="#chasse">Chasse</a></li>
<li><a class="modal-trigger vmv" href="#chose-pensante">Chose Pensante</a></li>
...
<li><a class="modal-trigger electre" href="#communaute">Communauté</a></li>
...
<li><a class="modal-trigger vmv" href="#creation">Création</a></li>
<li><a class="modal-trigger electre" href="#creation-intellectuelle">Création Intellectuelle</a></li>
<li><a class="modal-trigger electre" href="#credo">Credo</a></li>
...
<li><a class="modal-trigger vmv" href="#divination">Divination</a></li>
...
<li><a class="modal-trigger vmv" href="#emanation">Emanation</a></li>
<li><a class="modal-trigger electre" href="#emanation-vitale">Emanation Vitale</a></li>
...
<li><a class="modal-trigger vmv" href="#imperatif-moral">Impératif Moral</a></li>
...
<li><a class="modal-trigger vmv" href="#masculinisme">Masculinisme</a></li>
<li><a class="modal-trigger electre" href="#materialiste">Matérialiste</a></li>
<li><a class="modal-trigger electre" href="#matiere-esprit">Matière Esprit</a></li>
...
<li><a class="modal-trigger electre" href="#nature-humanite">Nature-Humanité</a></li>
...
<li><a class="modal-trigger vmv" href="#pere">Père</a></li>
...
<li><a class="modal-trigger vmv" href="#proprio">Proprio</a></li>
...
<li><a class="modal-trigger electre" href="#sang">Sang</a></li>
<li><a class="modal-trigger vmv" href="#sauvage">Sauvage</a></li>
<li><a class="modal-trigger electre" href="#science-du-neuf">Science du Neuf</a></li>
<li><a class="modal-trigger vmv" href="#secret">Secret</a></li>
<li><a class="modal-trigger vmv" href="#sociable">Sociable</a></li>
<li><a class="modal-trigger electre" href="#societe-de-personnes">Société de Personnes</a></li>
<li><a class="modal-trigger electre" href="#sol">Sol</a></li>
...
<li><a class="modal-trigger vmv" href="#terre-promise">Terre Promise</a></li>
<li><a class="modal-trigger vmv" href="#territoires">Territoires</a></li>
<li><a class="modal-trigger vmv" href="#theorie">Théorie</a></li>
<li><a class="modal-trigger electre" href="#tout-nouveau-peuple">Tout Nouveau Peuple</a></li>
...
<li><a class="modal-trigger electre" href="#voues">Voués</a></li>
